...
|--------------|-------------|--------|
| [cursor02-account](https://github.com/lizhihome/cursor02-account/tree/AIEE-pre) | AI Powered Engineer main->ts->rag_docker->AIEE-pre: https://ztop.pro/  | ⭐ | |
| [OpenClaw](https://github.com/lizhihome/clawd) | 我的私人助理。Mac Mini上部署，包括大智系统| ⭐ | |
| [大志股票分析](https://github.com/lizhihome/stock-research-2030) | 2030目标和方案: https://ztop.pro/finance/| ⭐ | |
| [zhiAI](https://github.com/lizhihome/zhiAI) | Zhi AI Apps List: https://ztop.pro/zhiAI/| ⭐ | |
...
| [Obsidian Notes](https://github.com/lizhihome/zhiNotes) | 日记，Obsidian | 👷‍♂️ | |
| [PDF ocr node js](https://github.com/lizhihome/gemini-ocr)| OCR pdf, extract image to json with text extraction| 📄 | |
| [pdf-ocr python](https://github.com/lizhihome/pdf-ocr) | Use Gemini API to convert pdf img to text | 👷‍♂️ | |
